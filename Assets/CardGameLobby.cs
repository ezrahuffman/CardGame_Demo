...
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
    private async void KitchenGameMultiplayer_OnPlayerDataNetworkListChanged(object sender, EventArgs e)
    {
        ...
        if (GameController.instance.HasAvailablePlayerSlots()) {
...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
    ...
    private async void HandleUpdateBackfillTickets() {
        if (backfillTicketId != null && payloadAllocation != null && GameController.instance.HasAvailablePlayerSlots()) {
            ...
            foreach (PlayerData playerData in GameController.instance.GetPlayerDataNetworkList()) {
    ...
    public async void CreateLobby(string lobbyName, bool isPrivate)
    {
        ...
        try
        {
            ...
            GameController.instance.StartHost(); // TODO: don't think we want to have a host like this
            Loader.LoadNetwork(Loader.Scene.CharacterSelectScene);
        }
        catch (LobbyServiceException e)
        {
